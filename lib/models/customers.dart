...
class CustomerFields {
  ...
  static List<String> getCustomerFields() =>
      [id, name, buildingNo, streetName, district, city, country, postalCode, additionalNo, vatNumber, contactNumber, address];
}
...
class Customer {
  ...
  const Customer({
    ...
    this.postalCode = '',
    this.additionalNo = '',
    this.vatNumber = '000000000000000',
    this.contactNumber = '',
    this.address = '',
  });
  ...
  factory Customer.fromJson(dynamic json) {
    return Customer(
      ...
      address: json[CustomerFields.address] ?? '',
    );
  }
